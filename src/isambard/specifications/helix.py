...
class Helix(Polypeptide):
    ...
    def __init__(self, aa=10, helix_type="alpha"):
        ...
        self.residues_per_turn, self.rise_per_residue = _helix_parameters[
            self.helix_type
        ]
...
class HelicalHelix(Polypeptide):
    ...
    def curve(self):
        ...
        return HelicalCurve.pitch_and_radius(
            self.major_pitch, self.major_radius, handedness=self.major_handedness
        )
    ...
    def build(self):
        ...
        if self.orientation != -1:
            ...
            initial_angle = dihedral(
                ...
                numpy.array(
                    [
                        primitive_coords[0][0],
                        primitive_coords[0][1],
    ...
    def get_orient_angle(
        ...
        if (monomer_index < len(self)) and monomer_index != -1:
            ...
            raise ValueError(
                ...
                "length of the polymer ({1})".format(monomer_index, len(self))
            )
        angle = dihedral(
            reference_point,
    ...
    def rotate(self, angle, axis, point=None, radians=False):
        super(HelicalHelix, self).rotate(
